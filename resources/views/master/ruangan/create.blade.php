...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / Ruangan /</span> Tambah</h4>
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('pegawai-tu.master.ruangan.store') }}" method="POST">
                        @csrf

                        @include('master.ruangan.partials.form')
