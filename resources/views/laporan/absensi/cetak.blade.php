...
<head>
    ...
    <title>Laporan Absensi Siswa - {{ $semester?->tahunAkademik?->nama }}</title>
    ...
    <style>
        * { box-sizing: border-box; font-family: 'Public Sans', Arial, sans-serif; }
        ...
        .rekap-box { display: flex; justify-content: space-around; border: 1px solid #ddd; padding: 10px; margin-bottom: 20px; background: #fdfdfd; font-size: 9pt; }
        .rekap-item { text-align: center; }
        .rekap-item strong { display: block; font-size: 12pt; }
...
@endphp
    ...
    <div class="no-print-bar">
        <div>
            <strong>Laporan Rekapitulasi Presensi & Kehadiran Siswa</strong>
    ...
    <div class="report-page">
        ...
        <div class="rekap-box">
            <div class="rekap-item">
                <span>Hadir</span>
                <strong style="color: #2e7d32;">{{ $rekap['hadir'] }}</strong>
            </div>
            <div class="rekap-item">
                <span>Terlambat</span>
                <strong style="color: #ed6c02;">{{ $rekap['terlambat'] }}</strong>
            </div>
            <div class="rekap-item">
                <span>Izin</span>
                <strong style="color: #0288d1;">{{ $rekap['izin'] }}</strong>
            </div>
            <div class="rekap-item">
                <span>Sakit</span>
                <strong style="color: #1976d2;">{{ $rekap['sakit'] }}</strong>
            </div>
            <div class="rekap-item">
                <span>Alpa</span>
                <strong style="color: #d32f2f;">{{ $rekap['alpa'] }}</strong>
            </div>
            <div class="rekap-item">
                <span>Tingkat Kehadiran</span>
                <strong style="color: #696cff;">{{ $rekap['persentase_kehadiran'] }}%</strong>
            </div>
        </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center py-3">Tidak ada data absensi yang sesuai filter.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
